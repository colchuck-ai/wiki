...
- **C008 - Lifecycle & Retirement**: when the steward chooses to retire an out-of-scope drift candidate, C008 executes the deprecation. C010 surfaces the candidate; C008 removes it. C010 excludes the charter concept from retirement candidacy.
